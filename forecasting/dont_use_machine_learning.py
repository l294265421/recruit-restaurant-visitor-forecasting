"""
https://www.kaggle.com/h54k3y/don-t-use-machine-learning/code
"""
import pandas as pd
import numpy as np
...
df_ah_dh = air_visit_data.groupby(['air_store_id','holiday_flg','day_of_week'])['visitors'].median().reset_index()
df_ah_wh = air_visit_data.groupby(['air_store_id','non_buis_day'])['visitors'].median().reset_index()
