...
plt.hist(air_reserve.reserve_visitors, bins=50, range=(0,50))
...
plt.hist(visit_hours, bins=24, range=(0, 23))
...
plt.hist(reserve_hours, bins=24, range=(0, 23))
